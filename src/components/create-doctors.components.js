...
export default class CreateDoctorlist extends Component {
  constructor(props) {
    super(props);
 ...
 onChangeoffduty(e) {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:4000/Doctor/add', doctor)
  ...
  render() {
    ...
    <div>
      ...
      <form onSubmit={this.onSubmit}>
        ...
        <div className="form-group">
          <input type="submit" value="Create Doctor Log" className="btn btn-primary" />
        </div>
      </form>
    </div>
    )
